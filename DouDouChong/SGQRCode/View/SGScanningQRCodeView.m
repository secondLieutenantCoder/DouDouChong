...
/** 扫描动画线(冲击波) 的高度 */
static CGFloat const animation_line_H = 1;
/** 扫描内容外部View的alpha值 */
...
- (void)setupScanningQRCodeEdging {
    ...
    _animation_line.image = [UIImage imageNamed:@"animationGreenView"];
    _animation_line.frame = CGRectMake(scanContent_X * 0.5+15, scanContent_layerY, self.frame.size.width - scanContent_X-30, animation_line_H);
...
//    light_button.layer.borderColor = [UIColor lightGrayColor].CGColor;
//    light_button.layer.cornerRadius = 5;
//    
